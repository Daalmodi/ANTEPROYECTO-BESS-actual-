...
\hrule
\vspace*{0.2\baselineskip}
\input{secciones/informaciónproyecto/informeproyecto}
\newpage
\section{Contexto}
\vspace*{0.08\baselineskip}
\hrule
\vspace*{0.2\baselineskip}
\input{secciones/contexto/contexto}
...
\input{secciones/antecedentes/antecedentes}
...
\input{secciones/objetivos/objetivogeneral}
\subsection{Objetivos específicos}
\input{secciones/objetivos/objetivosespecificos}
...
\hrule
\vspace*{0.7\baselineskip}
\input{secciones/marcoconceptual/marcoconceptual}
...
\hrule
\vspace*{0.7\baselineskip}
\input{secciones/cronograma/cronograma.tex}
...
\hrule
\vspace*{0.7\baselineskip}
\input{secciones/Presupuesto/presupuesto.tex}
